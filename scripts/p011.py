...
for i in range(20):
    for j in range(20 - 3):
        product = product_in_direction(i, j, 0, 1)
...
for i in range(20 - 3):
    for j in range(20):
        product = product_in_direction(i, j, 1, 0)
        if product > greatest_product:
            greatest_product = product
...
for i in range(20 - 3):
    for j in range(20 - 3):
        product = product_in_direction(i, j, 1, 1)
        if product > greatest_product:
            greatest_product = product
...
print("The greatest product of four adjacent numbers in the grid is:", greatest_product)
