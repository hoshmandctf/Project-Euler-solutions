...
def find_maximum_total(triangle):
    ...
    for i in range(len(triangle) - 2, -1, -1):
        # Calculate the maximum total for each position in the current row
...
maximum_total = find_maximum_total(triangle)
print("The maximum total from top to bottom of the triangle is:", maximum_total)
